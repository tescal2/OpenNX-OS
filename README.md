# OpenNX-OS
A Sample Repo in order to store a router python example used in Cisco's Data Center Programmability Book around Open NX-OS and the industry from a network programmability perspective. 
