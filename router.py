...
def getRouter(rtr):
   router1 = {'os_version':'7.0.1','hostname':'nyc_router1','model':'Nexus 9372PX-E', \
   'domain':'cisco.com','mgmt_ip':'10.10.16.07'}
   router2 = dict( os_version='7.0.1', hostname='rtp_router2',model='Nexus 9372PX-E', \
   	domain='cisco.com', mgmt_ip='10.03.19.14')
   router3 = dict( os_version='7.0.1', hostname='ROUTER3',model='Nexus 9504', \
